...
<div class="box-header with-border">
  <h3 class="box-title">إضافة خدمة جديد</h3>
...
<form role="form" action="{{ url('/save-product') }}" enctype="multipart/form-data" method="post">
    ...
    <div class="box-body">
        ...
        <div class="form-group col-md-4">
          <label for="en_name">إسم  الخدمة</label>
          <input class="form-control" placeholder="إسم الخدمة ..." type="text" name="name" maxlength="30" required>
        </div>
        ...
        <div class="form-group col-md-4">
            ...
            <input class="form-control" placeholder="وصف  الخدمة..." type="text" name="decription" maxlength="30" required>
          </div>
